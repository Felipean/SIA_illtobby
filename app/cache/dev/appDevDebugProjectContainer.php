...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'felipe', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\Symfony\\src\\illtobby\\UserBundle\\Entity')), 'illtobby\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('illtobbyUserBundle' => 'illtobby\\UserBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '0a311bdd3f1e0921b7c0bf30d77bd2b028dd42e9');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Symfony\\src\\illtobby\\UserBundle/Resources/views', 'illtobbyUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0a311bdd3f1e0921b7c0bf30d77bd2b028dd42e9');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'illtobbyUserBundle' => 'illtobby\\UserBundle\\illtobbyUserBundle',
            ...
            'locale' => 'en',
            'secret' => '0a311bdd3f1e0921b7c0bf30d77bd2b028dd42e9',
            'database_path' => NULL,
            ...
            'kernel.secret' => '0a311bdd3f1e0921b7c0bf30d77bd2b028dd42e9',
